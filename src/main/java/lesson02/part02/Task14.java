...
public class Task14 {
    public static void main(String[] args) throws Exception {
        ...
        if (Math.floorMod(iNumber, 400) == 0) System.out.println("количество дней в году: 366");
        else if (Math.floorMod(iNumber, 100) == 0) System.out.println("количество дней в году: 365");
        else if (Math.floorMod(iNumber, 4) == 0) System.out.println("количество дней в году: 366");
